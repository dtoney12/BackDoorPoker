...
module.exports = {
  ...
  NotEnoughAccountCash:  (username)=>{ return { code: 16,  status: "Not enough account cash for player "+username,              }},
  NotEnoughTableCash:    (username)=>{ return { code: 17,  status: "$100 minimum table cash required to play at this table"     }},
  willJoinTable:         (username)=>{ return { code: 18,  status: "Player "+username+" is now in queue to join table",         }},
  ...
  getCashSuccess:        (username)=>{ return { code: 25,  status: "Player "+username+" sucessfully got cash",                  }},
  getTableCash:   (username, value)=>{ return { code: 26,  status: `Player ${username} transferred $${value} to Table Cash`,    }},
  tableCashError: (username, value)=>{ return { code: 27,  status: `Player ${username} cannot transfer $${value} to Table Cash`,}},
}
